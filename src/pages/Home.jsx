        ...
        <div className="relative z-10 max-w-screen-xl mx-auto px-4 py-28 md:px-8">
          <div className="flex flex-col items-center space-y-6 max-w-4xl mx-auto text-center">
            <h2 className="text-4xl text-white font-extrabold mx-auto md:text-5xl">
              Your Personal <span className="text-violet-400">BookStore</span>
            </h2>
            <p className="max-w-2xl mx-auto text-gray-400 text-md">
              Indulge in the curated elegance of your personal bookstore, where
              literary passions find their perfect match amidst a collection
              tailored to your unique tastes and interests.
            </p>
